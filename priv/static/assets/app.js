...
`, template.innerHTML.trim());
  ...
  Hooks2.Debug = {
    mounted() {
      console.log("This element is mounted", this.el);
    },
    beforeUpdate() {
      console.log("This element juste before updating", this.el);
    },
    updated() {
      console.log("This element has just been updated", this.el);
    },
    destroyed() {
      console.log("This element has been destroyed", this.el);
    },
    disconnected() {
      console.log("This elements' parent LiveView has been disconnected", this.el);
    },
    reconnected() {
      console.log("This elements' parent LiveView has been reconnected", this.el);
    }
  };
  ...
  window.addEventListener("phx:page-loading-start", (info) => {
    console.log("Phoenix page is loading");
    import_topbar.default.show();
  });
  window.addEventListener("phx:page-loading-stop", (info) => {
    console.log("Phoenix page stopped loading");
    import_topbar.default.hide();
  });
  window.addEventListener("phx:delayed", (detail) => {
    alert("Here is the delayed event");
  });
  liveSocket.connect();
